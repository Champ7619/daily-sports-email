...
config.user.time_zone = "America/Los_Angeles"; // Use https://timezonedb.com/time-zones to find your time zone 
config.user.time_hour = "1"; // "0" for "13:00", "1" for "1:00 PM"
// MLB team highlights
config.mlb.arizona_diamondbacks  = "false";
config.mlb.atlanta_braves        = "false";
config.mlb.baltimore_orioles     = "false";
config.mlb.boston_red_sox        = "false";
...
config.mlb.los_angeles_dodgers   = "false";
...
config.mlb.san_diego_padres      = "false";
